      ...
      <div class="relative p-3 mb-3 sm:p-5">
         ...
         <form action="{{ route('admin.alsintan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="gap-6 mb-4
               ...
               {{-- nama --}}
               <div class="mb-2">
                  <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Nama Alsintan</label>
                  <input type="text" name="name" id="name"
                     class="bg-gray-50 border border-gray-300 text-red-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                        ...
                        <div id="previewContainer"
                           ...
                           <div class="col-span-1">
                              ...
                              <button id="removeImage" type="button"
                                 class="absolute top-1 right-1  flex items-center justify-center shadow-lg ">
