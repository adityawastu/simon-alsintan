...
<ul class="space-y-2">
  ...
  <li>
    <a href="{{ route('admin.dashboard') }}"
      class="flex items-center p-2 text-base font-normal rounded-lg transition duration-150 ease-in-out
        {{ Route::is('admin.dashboard') ? 'bg-green-500 text-white' : 'text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">
      <svg aria-hidden="true"
        class="w-6 h-6 transition duration-75
              {{ Route::is('admin.dashboard') ? 'text-white' : 'text-black dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' }}"
        fill="currentColor" viewBox="0 0 20 20">
  ...
  {{-- Asset Management (with collapse) --}}
  <li>
    <button type="button"
    ...
    <ul id="dropdown-pages"
      class="{{ request()->routeIs('admin.data.alsintan') || request()->routeIs('admin.index.peta.lokasi') || request()->routeIs('admin.monitoring.aktivitas') ? 'py-2 space-y-2' : 'hidden py-2 space-y-2' }}">
      {{-- Data Alsintan --}}
      <li>
      ...
      {{-- Monitoring Aktivitas (label sesuai kodenya) --}}
      <li>
  ...
  <li>
    ...
    <ul id="dropdown-upja" class="{{ request()->routeIs('admin.upja.index') ? 'py-2 space-y-2' : 'hidden py-2 space-y-2' }}">
      <li>
